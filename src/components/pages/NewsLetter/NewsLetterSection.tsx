const html = {
  ...
  <div id="mc_embed_signup">
      <form action="https://solomiyamag.us11.list-manage.com/subscribe/post?u=ad9b9441eaecf9358e4b5f0d0&amp;id=5615bdd19b&amp;f_id=008190e0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_self" novalidate="">
          <div id="mc_embed_signup_scroll"><h2 class="text-center font-yuni-hair text-title md:text-title-md lg:text-title-lg xl:text-title-xl">Subscribe to our Newsletter</h2>
              <div class="mc-field-group font-nice-regular"><label class="md:text-2xl xl:text-3xl" for="mce-EMAIL">Email Address <span class="asterisk">*</span></label>
                <input type="email" name="EMAIL" class="md:mt-4 md:py-4 xl:py-6 lg:text-xl xl:text-3xl required email bg-gray-200 border border-solid border-gray-700 text-gray-900 text-sm rounded-lg block w-full p-2.5" id="mce-EMAIL" required="" value="">
              </div>
...
export const NewsLetterSection = () => (
  <div className="grid h-screen max-h-[90vh] w-full max-w-limit place-items-center">
    <div dangerouslySetInnerHTML={html} className="mx-auto w-full max-w-[80%] lg:max-w-[50%]" />
  </div>
);
