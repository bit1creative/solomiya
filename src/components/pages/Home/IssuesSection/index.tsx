...
export const IssuesSection = () => {
  ...
  if (isFirstIssue) {
    return (
      <section className="snap-start px-4 text-center font-nice-regular text-3xl lg:px-20 lg:text-6xl lg:leading-[4rem]">
    ...
    return (
      <section className="snap-start px-4 text-center font-nice-regular text-3xl lg:px-20 lg:text-6xl lg:leading-[4rem]">
        ...
        artworks that were created in Kherson despite the russian occupation <IssueTextImage image="sm2_kherart" />; to
        read the stories of Ukrainians who had to run from the war twice — in 2014 and 2022{' '}
        ...
        Kalinichenko and others. This issue created in Kyiv and designed in Berlin, is a testament to resistance through
        the means of art.
      </section>
    );
  }
