...
export const Footer = () => {
  ...
  return (
    <div className={`mt-6 border-${mainColor} w-screen border-0 border-t-[2.5rem] border-solid`}>
      <div className="sr-only border-main-issue-1" />
      <div className="sr-only border-main-issue-2" />
      <div
        className={`grid max-w-[1440px] grid-cols-3 gap-x-4 gap-y-2 bg-white text-center font-yuni-black text-2xl lg:grid-cols-5 lg:py-4 lg:text-6xl lg:leading-[4rem]`}
      >
